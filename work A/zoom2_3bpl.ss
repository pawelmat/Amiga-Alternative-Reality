...
zoom_zoom:	lea	$dff000,a0
		...
		move	#[500*64],$58(a0)
		move.l	#zoom_plane,scron
		move.l	#zoom_plane+[258*44],scroff
		waitblt
		lea	zoom_load,a1
...
zoom_chgl:	move	d1,6(a1)
		...
		move.l	scron,d1
		addi.l	#[zoom_offset*3*[zoom_row]],d1
		move.l	d1,$50(a0)
...
zoom_itis_0:	move	d3,(a1)
		...
		move.l	#zoom_plane+[zoom_offset*3*[zoom_row]],$50(a0) ;a
		move.l	#zoom_maska,$4c(a0)	;b
		move.l	#zoom_plane+[zoom_offset*3*[zoom_row]]-2,$48(a0) ;c
		move.l	#zoom_plane+[zoom_offset*3*[zoom_row]]-2,$54(a0) ;d
		move	d0,$58(a0)
