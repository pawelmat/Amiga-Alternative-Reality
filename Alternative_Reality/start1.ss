...
ddd:	raster
	...
	move	#[3*lo_heith*64]+[lo_row/2],$58(a0)
	waitblt
	bsr	lo_initcop
...
DL_set: move	#$8210,$dff096
	...
	move.l	(a0),$dff020
	move	#$4000,$dff024
DL_ready:btst	#5,$bfe001
	bne.s	DL_ready
	move	#$9980,$dff024
	move	#$9980,$dff024
	move	#$0002,$dff09c
DL_ready2:btst	#1,$dff01f
	beq.s	DL_ready2
	move	#$4000,$dff024
	bsr	DL_Trackuncode
...
DL_HeadIN:lea	DL_TRKno(pc),a0
	addq	#1,(a0)
	move.b	#%01111101,$bfd100
	move.b	#%01111100,D7
	and.b	-2(a0),D7
	bra.s	DL_sel
DL_HeadOUT:lea	DL_TRKno(pc),a0
	subq	#1,(a0)
...
DL_cp1a:move.l	(A0)+,D1
	...
	movem.l (A7)+,d0-d7/a0-a6
	rts
DL_uncode:movem.l D0-D7/a0-a6,-(A7)
	moveq	#$0f,D2
	move.l	#$55555555,d3
	lea	DL_data(PC),A1
DL_uncodeLP:
...
lo_end=offset+$900+$2800+$280+$2c88
